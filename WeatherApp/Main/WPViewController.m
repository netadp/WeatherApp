...
- (void)viewDidLoad
{
	...
	RAC(hiloLabel, text) = [[RACSignal combineLatest:@[RACObserve([WXManager sharedManager], currentCondition.tempHigh), RACObserve([WXManager sharedManager], currentCondition.tempLow)] reduce:^id(NSNumber *hi, NSNumber *low){
...
-(void)configureHourlyCell:(UITableViewCell *)cell weather:(WXCondition*)weather
{
	...
	cell.detailTextLabel.text = [NSString stringWithFormat:@"%.0fº", weather.temperature.floatValue];
...
-(void)configureDailyCell:(UITableViewCell *)cell weather:(WXCondition *)weather
{
	...
	cell.detailTextLabel.text = [NSString stringWithFormat:@"%.0fº / %.0fº", weather.tempHigh.floatValue, weather.tempLow.floatValue];
	cell.imageView.image = [UIImage imageNamed:weather.imageName];
	cell.imageView.contentMode = UIViewContentModeScaleAspectFit;
}
